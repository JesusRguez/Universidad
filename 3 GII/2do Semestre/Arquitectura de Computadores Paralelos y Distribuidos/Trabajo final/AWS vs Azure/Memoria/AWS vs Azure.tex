...
%	\thispagestyle{empty}
	...
	\part{Introducción}
	\include{Introduccion/AWS}
	\include{Introduccion/Azure}
	
	\part{Características y limitaciones}
	\include{Conceptos/CaracteristicasAWS}
	\include{Conceptos/CaracteristicasAzure}
	
	\part{Comparación de los servicios ofrecidos por AWS y Azure}
	\include{Comparaciones/CreacionMV}
	\include{Comparaciones/CreacionWeb}
	\include{Comparaciones/CreacionIC}
