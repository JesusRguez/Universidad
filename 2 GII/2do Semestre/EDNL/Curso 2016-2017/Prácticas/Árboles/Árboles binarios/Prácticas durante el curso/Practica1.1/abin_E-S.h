...
template <typename T> void rellenarDescendientes(typename Abin<T>::nodo r, Abin<T>& A, const T& fin)
...
template <typename T> void rellenarDescendientes(istream& is, typename Abin<T>::nodo r, Abin<T>& A, const T& fin)
// Pre: r es un nodo hoja de A.
...
template <typename T> void imprimirAbin (ostream& os, const Abin<T>& A, const T& fin)
...
template <typename T> void imprimirDescendientes (ostream& os, typename Abin<T>::nodo r, const Abin<T>& A, const T& fin)
