...
// árbol no vacío
if (e < r->elto)
// quitar e del subárbol izqdo.
r->izq.eliminar(e);
else if (r->elto < e)
// quitar e del subárbol drcho.
r->der.eliminar(e);
else
// quitar e de la raíz
...
arbol* a = r->izq.r;
r->izq.r = 0;
// impide destruir el subárbol izqdo.
delete(r);
r = a;
}
else if (r->izq.r == 0) {
...
arbol* a = r->der.r;
r->der.r = 0;
// impide destruir el subárbol drcho.
delete(r);
r = a;
}
else
// 4. Raíz tiene dos hijos
// Eliminar el mínimo del subárbol derecho y sustit
uir
...
delete(r);
r = hd;
// sustituir r por el subárbol drcho.
return e;
}
else
...
// copiar subárbol izqdo.
r->der.copiar(A.r->der);
// copiar subárbol drcho.
}
}
