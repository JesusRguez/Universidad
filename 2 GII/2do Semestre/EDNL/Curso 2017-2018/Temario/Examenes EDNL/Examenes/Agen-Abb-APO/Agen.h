...
inline void Agen<T>::insertarHijoIzqdo(Agen<T>::nodo n, const T& e)
{
	...
	n->hizq = new celda(e, n);// El actual hijo izqdo. se convierte en hermano drcho. del nuevo hijo
	n->hizq->heder = hizqdo;
}
...
inline void Agen <T>::insertarHermDrcho(Agen<T>::nodo n, const T& e) 
{
	...
	n->heder = new celda(e, n->padre); // El actual hermano drcho. se convierte en hermano drcho. del nuevo
