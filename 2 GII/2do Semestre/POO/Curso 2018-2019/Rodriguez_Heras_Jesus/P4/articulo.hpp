...
public:
	...
	inline const Fecha& f_publi() const noexcept { return fecha_publi_; }

	//Mostrar precio:
	inline const double precio() const noexcept { return precio_; }
...
public:
	...
	//Mostrar tam:
	inline unsigned tam() const noexcept { return tam_; }
