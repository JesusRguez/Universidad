...
template <typename T>
Cola<T>::Cola(size_t TamaMax) : elementos(new T[TamaMax + 1]),  Lmax(TamaMax + 1), inicio(0), fin(TamaMax)// +1 para detectar cola llena
{}

template <typename T>
Cola<T>::Cola(const Cola<T>& C) : elementos(new T[C.Lmax]), Lmax(C.Lmax), inicio(C.inicio), fin(C.fin)
{
